  ...
  head: () => ({
    meta: [
      { title: "Contact LabTrack" },
      {
        name: "description",
        content:
          "Get in touch with the LabTrack team — questions, demos, and partnership inquiries.",
      },
    ],
  }),
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          className="liquid-orb animate-blob absolute bottom-0 right-0 h-[420px] w-[420px] opacity-50"
      ...
      <div className="mx-auto max-w-6xl px-4 pt-20 pb-24 lg:px-8 lg:pt-28">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-pretty text-muted-foreground sm:text-lg">
            Whether you're a lab director, instructor, or curious student — drop us a line and our
          ...
          >
            <div className="liquid-card rounded-3xl p-6">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                We answer every message — usually within a few hours during business days. For
                urgent lab issues, call our hotline.
              </p>
              <div className="mt-5 space-y-3 text-sm">
                <div className="flex items-center gap-2 text-muted-foreground">
                  <Clock className="h-4 w-4 text-accent" /> Mon–Fri · 9am–6pm PT
                </div>
                <div className="flex items-center gap-2 text-muted-foreground">
                  <Globe className="h-4 w-4 text-accent" /> Serving labs worldwide
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                We'll review and reach back out — promise.
              </p>
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-2">
            {[
              [
                ...
                "Most messages get a reply within a few hours on business days.",
              ],
              [
                "Do you offer demos?",
                "Yes — request a 20-minute walkthrough and we'll tailor it to your lab.",
              ],
              [
                "Is LabTrack free for academia?",
                "Yes, accredited educational institutions get full academic access.",
              ],
              [
                "Can we self-host?",
                "Get in touch — we have a self-host package for larger institutions.",
              ],
            ].map(([q, a]) => (
              <details key={q} className="liquid-card group rounded-2xl p-5">
                <summary className="flex cursor-pointer items-center justify-between font-medium">
                  {q}
                  <span className="grid h-6 w-6 place-items-center rounded-full bg-gradient-to-br from-primary to-accent text-primary-foreground text-xs transition-transform group-open:rotate-45">
                    +
                  </span>
                </summary>
