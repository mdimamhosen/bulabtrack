...
import { Target, Lightbulb, Users, Code, Calendar, Award, Sparkles, Rocket, Brain, Shield, Heart, Zap } from "lucide-react";
...
const values = [
  { I: Brain, t: "Intelligent by design", d: "Every workflow is shaped around real lab staff routines, not generic SaaS templates." },
  { I: Shield, t: "Trust at the core", d: "Row-level security, audit trails and role-based access by default." },
  { I: Heart, t: "Crafted with care", d: "Pixel-perfect surfaces, animated micro-interactions, accessible by default." },
  { I: Zap, t: "Edge-fast performance", d: "Built on a modern edge runtime — sub-second responses globally." },
];

const milestones = [
  { y: "2025 Q3", t: "Requirements gathered", d: "Interviewed lab staff, instructors and IT coordinators across 3 universities." },
  { y: "2025 Q4", t: "Design system shipped", d: "Dark-first, glassmorphic, accessible token system in Figma & Tailwind." },
  { y: "2026 Q1", t: "Inventory + Auth live", d: "Phase 1: catalog, dashboard, role-based auth and RLS hardening." },
  { y: "2026 Q2", t: "Public storefront", d: "Phase 2: COD checkout, order pipeline, contact and FAQ surfaces." },
  { y: "2026 Q3", t: "AI-themed redesign", d: "Phase 3: futuristic glassmorphic refresh with aurora visuals." },
];
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="liquid-orb animate-blob absolute top-1/2 right-0 h-[420px] w-[420px] opacity-50" style={{ animationDelay: "-8s" }} />
      </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pt-20 pb-16 lg:px-8 lg:pt-28">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-base text-muted-foreground sm:text-lg">
            A modern, open platform built to give institutions full, intelligent control over every peripheral they own — from catalog to checkout.
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((s, i) => (
            <motion.div key={s.l} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}
        ...
        <div className="mt-20 grid gap-6 md:grid-cols-2">
          {[
            { I: Target, t: "Our Mission", d: "Empower educators and lab staff with effortless inventory management that scales with their institution — without sacrificing beauty or rigor." },
            { I: Lightbulb, t: "Our Vision", d: "Become the default operating system for academic computer laboratories worldwide, blending intelligent automation with delightful UX." },
          ].map(({ I, t, d }, i) => (
        ...
        <section className="mt-24">
          <div className="text-center">
            <Badge variant="outline" className="liquid-card">Our values</Badge>
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">What we believe in</h2>
          </div>
        ...
        <section className="mt-24">
          <div className="text-center">
            <Badge variant="outline" className="liquid-card">Benefits</Badge>
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">Built for institutions, loved by staff</h2>
          </div>
          <ul className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.li key={b} initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }}
                className="liquid-card flex items-start gap-3 rounded-xl p-4 text-sm">
                <span className="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-md bg-gradient-to-br from-primary to-accent text-[10px] font-bold text-primary-foreground">✓</span>
                {b}
              </motion.li>
            ))}
          </ul>
        ...
        <section className="mt-24">
          <div className="text-center">
            <Badge variant="outline" className="liquid-card">Journey</Badge>
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">From idea to platform</h2>
          </div>
          <div className="relative mx-auto mt-14 max-w-3xl">
            ...
            {milestones.map((m, i) => (
              <motion.div key={m.t} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}
                className={`relative mb-10 md:grid md:grid-cols-2 md:gap-10 ${i % 2 ? "md:[&>div:first-child]:order-2" : ""}`}>
                <div className={`hidden md:block ${i % 2 ? "text-left pl-10" : "text-right pr-10"}`}>
        ...
        <section className="mt-24">
          <div className="text-center">
            <Badge variant="outline" className="liquid-card">Under the hood</Badge>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.div key={x.t} initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }}
        ...
        <section className="mt-24">
          <div className="text-center">
            <Badge variant="outline" className="liquid-card">Project team</Badge>
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">The humans behind the pixels</h2>
          </div>
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            {[
              ...
              <motion.div key={p.n} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                ...
                <p className="relative text-xs uppercase tracking-widest text-muted-foreground">{p.r}</p>
              </motion.div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-24">
          <div className="liquid-card relative overflow-hidden rounded-3xl p-10 text-center">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-sm text-muted-foreground">A capstone-quality, production-ready academic project — engineered to ship.</p>
